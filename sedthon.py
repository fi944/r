...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('اهلا مطوري رضا - @Ridhav')

ownerhson_id = 881535564
@sedthon.on(events.NewMessage(outgoing=False, pattern='/me'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply(' نعم سيدي ')

ownerhson_id = 881535564
@sedthon.on(events.NewMessage(outgoing=False, pattern='/i'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply(' انا احبك للموت ')
	
ownerhson_id = 881535564
@sedthon.on(events.NewMessage(outgoing=False, pattern='/n'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply(' نرتبط حياتي؟  ')

ownerhson_id = 881535564
@sedthon.on(events.NewMessage(outgoing=False, pattern='/w'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply(' راتب ')
	
ownerhson_id = 881535564
@sedthon.on(events.NewMessage(outgoing=False, pattern='/ww'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply(' بخشيش  ')

ownerhson_id = 881535564
@sedthon.on(events.NewMessage(outgoing=False, pattern= '/roro'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
